...
import { z } from 'zod';
import { signInWithOAuth } from "@/util/auth-helpers/client";
      ...
      <div className="mx-auto h-full sm:w-max">
        <div className="m-auto  py-6">
          <div className="mt-12 rounded-3xl border bg-gray-50 dark:border-gray-700 dark:bg-gray-800 -mx-6 sm:-mx-10 p-8 sm:p-10">
            <h3 className="flex justify-center text-2xl font-semibold text-gray-700 dark:text-white">
                          <a href="/">
        ...
        >
          <div className="w-max mx-auto flex items-center justify-center space-x-4 text-white">
            ...
            <span className="text-sm tracking-wide text-sky-600 dark:text-sky-400">Forgot password ?</span>
              ...
              <div>
                <div className="relative before:absolute before:bottom-0 before:h-0.5 before:left-0 before:origin-right focus-within:before:origin-left before:right-0 before:scale-x-0 before:m-auto before:bg-sky-400 dark:before:bg-sky-800 focus-within:before:!scale-x-100 focus-within:invalid:before:bg-red-400 before:transition before:duration-300">
                  <input {...register("invition")} type="text" placeholder="invition code" className="w-full bg-transparent pb-3  border-b border-gray-300 dark:placeholder-gray-300 dark:border-gray-600 outline-none  invalid:border-red-400 transition" />
                </div>
              </div>
              ...
              <div>
                ...
                <button type="reset" className="-ml-3 w-max p-3">
                  <Link href="/login" className="text-sm tracking-wide text-sky-600 dark:text-sky-400">To Login</Link>
                </button>
              </div>
            </form>
          </div>
